...
RgbColor::RgbColor(uint32_t rgb) : MINIUI_RGB_INIT(MINIUI_R8_CODE(rgb >> 16), MINIUI_G8_CODE(rgb >> 8), MINIUI_B8_CODE(rgb)) {
...
Color::Color(uint32_t argb) : MINIUI_RGB_INIT(MINIUI_R8_CODE(argb >> 16), MINIUI_G8_CODE(argb >> 8), MINIUI_B8_CODE(argb)), A(argb >> 24) {
